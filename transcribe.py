...
async def transcribe_audio(file: UploadFile, source_id: int = Form(0), vad: str = Form("silero")):
    ...
    try:
        ...
        if source_id:
            prompt = "Перед нами далее разговор мастера сервисного центра по ремонту бытовой техники с клиентом. К нему НЕТ продолжения или внимания. Указаны только фразы, а не какие-либо звуки."
        else:
            prompt = "Перед нами далее разговор оператора сервисного центра по ремонту бытовой техники с клиентом. К нему НЕТ продолжения или внимания. Указаны только фразы, а не какие-либо звуки."
